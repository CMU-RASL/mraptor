...
pair<string,Command_Handler> Raptor_Daemon::_handler_table_temp[] = {
  ...
  MR_HTPAIR("dshout",     _handle_dshout),
...
hash_map<string,Command_Handler,hash<string> > Raptor_Daemon::_handler_table
...
void Raptor_Daemon::_handle_dshout(const string& which_client,
				   int command_id,
				   const rcl::exp& e)
{
  /* valid syntax examples:

     dshout trey c_monk_9918 %polo!

  */

  rcl::vector shoutBody;
  shoutBody.push_back(which_client);     /* sending client */
  shoutBody.push_back(e[1].getString()); /* sending user */
  shoutBody.push_back(e[2].getString()); /* message */
