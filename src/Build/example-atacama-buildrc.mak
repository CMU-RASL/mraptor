...
# $Id: example-atacama-buildrc.mak,v 1.1 2004/05/21 19:16:58 trey Exp $
#
# PROJECT:      Life in the Atacama
# DESCRIPTION:  install this file as ~/.atacama.buildrc to set up
...
######################################################################
# $Log: example-atacama-buildrc.mak,v $
