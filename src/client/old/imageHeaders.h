...
extern const char *asteroid_h[];
extern const char *atmosphereImpact1_h[];
extern const char *atmosphereImpact2_h[];
extern const char *oceanImpact_h[];
extern const char *brontoMeteor_h[];
extern const char *flamingAtmosphere_h[];
extern const char *meteorBlue_xpm[];
extern const char *meteorCartoon_xpm[];
extern const char *meteorCrater_xpm[];
extern const char *meteorFlaming_xpm[];
extern const char *flamingDinos_h[];
extern const char *microRaptor_xpm[];

#endif

extern const char *blankImage_xpm[];
extern const char *hideImage_xpm[];
extern const char *killImage_xpm[];
extern const char *maximizeImage_xpm[];
extern const char *runImage_xpm[];
extern const char *subImage_xpm[];
extern const char *throwupImage_xpm[];
extern const char *unsubImage_xpm[];
extern const char *miniClawImage_xpm[];
extern const char *flagImage_xpm[];
/***************************************************************
 * Revision History:
